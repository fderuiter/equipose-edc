...
public class InteropServiceIT extends AbstractIntegrationTest {
    ...
    public void testUpsertSyntaxExecution() {
        ...
        jdbcTemplate.execute("DROP TABLE IF EXISTS audit_event CASCADE; CREATE TABLE audit_event (AUDIT_ID SERIAL PRIMARY KEY, AUDIT_DATE TIMESTAMP, AUDIT_TABLE VARCHAR(255), USER_ID INT, ENTITY_ID INT, REASON_FOR_CHANGE VARCHAR(255), ACTION_MESSAGE VARCHAR(255))");
